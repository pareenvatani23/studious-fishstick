...
export const themes: Record<ThemeName, Theme> = {
  ...
  warmSand: {
    ...
    swatch: '#F3EFE9',
    colors: {
      // Modern warm-minimal: clean off-white paper, cool-grey neutrals (no muddy
      // brown), and a fresh emerald + soft violet accent. Reads calm and premium.
      background: '#F4F1EC',
      card: '#FFFFFF',
      elevated: '#FFFFFF',
      soft: '#ECE8E1',
      ...
      text2: '#6E6A64',
      muted: '#A6A29A',
      border: 'rgba(34,32,29,0.08)',
      borderStrong: 'rgba(34,32,29,0.15)',
      borderWidth: 1,
      onAccent: '#FFFFFF',
